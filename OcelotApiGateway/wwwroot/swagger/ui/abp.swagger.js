...
(function () {
    ...
    function loginUserInternal(tenantId, callback) {
        ...
        xhr.open('POST', abp.appPath + 'v1/api/TokenAuth/Authenticate', true);
    ...
    abp.swagger.login = function (callback) {
        ...
        if (tenancyName) {
            ...
            xhrTenancyName.open('POST', abp.appPath + 'v1/api/services/app/Account/IsTenantAvailable', true);
    ...
    abp.swagger.logout = function (callback) {
        ...
        xhrLogout.open('GET', abp.appPath + 'v1/api/TokenAuth/LogOut', true);
